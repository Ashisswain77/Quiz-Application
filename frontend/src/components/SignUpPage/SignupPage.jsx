    ...
    const handleSubmit = async (ev) => {
        ...
        try {
            ...
            if(data?.token) {
                try {
                    ...
                    localStorage.setItem(
                        "currentUser",
                        JSON.stringify(data.user || {email: email.trim().toLowerCase(), name: name.trim()})
                    );
                } catch (e) {
                    console.log(e);
                }
            ...
            if (typeof onSignupSuccess === "function") {
                try {
                    onSignupSuccess(data?.user || {email: email.trim().toLowerCase(), name: name.trim()});
                } catch (e) {
                    console.log(e);
                }
            }
                ...
                <div className={signupStyles.animatedBorder}>
                    <div className={signupStyles.formContent}>
                        ...
                        <p className={signupStyles.subtitle}>
                            Create an account to start using Quiz Application.
                        </p>
